...
export const scanFieldsCompactStr = addon.scanFieldsCompactStr as ((input: string, out: Buffer, content: Buffer) => number | bigint) | undefined;
...
export const inferCsvStr = addon.inferCsvStr as ((input: string, out: Buffer, hasHeaders: boolean, maxSamples: number) => number | bigint) | undefined;
